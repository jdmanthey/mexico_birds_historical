options(scipen=999)
project_directory <- "/lustre/scratch/jmanthey/08_mexico/06_stats_atl"
directory_name <- "35_stats_atl"
cluster <- "nocona"
max_number_jobs <- 400
...
vcf_header <- paste0(project_directory, "/CM051596.1.recode.vcf.gz")
...
ref_index <- read.table("GCA_028018845.1_bMelGeo1.pri_genomic.fna.fai", stringsAsFactors=F)
